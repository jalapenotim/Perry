...
namespace SLRCClassroom.Tools
{
    ...
    public partial interface ITools
    {
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void VisibilityJoin(ToolsBoolInputSigDelegate callback);
    ...
    internal partial class Tools : ITools, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            internal static class Booleans
            {
                ...
                /// </summary>
                public const uint VisibilityJoinState = 3;
        ...
        private void Initialize(uint controlJoinId, uint? itemCount)
        {
            ...
            Occupancy = new SLRCClassroom.Tools.Occupancy(ComponentMediator, 2);
            ProjectorHours = new SLRCClassroom.Tools.ProjectorHours(ComponentMediator, 3);
        }
        ...
        /// <inheritdoc/>
        public void VisibilityJoin(ToolsBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
