...
namespace SLRCUser.PublicDisplays
{
    ...
    public partial interface IPublicDisplays
    {
        ...
        /// </summary>
        SLRCUser.PublicDisplays.IPDRouting PDRouting { get; }

        /// <summary>
        /// ComplexComponent PD Lower Level
        /// </summary>
        SLRCUser.PublicDisplays.PDLowerLevel.IPDLowerLevel PDLowerLevel { get; }

        /// <summary>
        /// ComplexComponent PD 1st Floor
        /// </summary>
        SLRCUser.PublicDisplays.PD1stFloor.IPD1stFloor PD1stFloor { get; }

        /// <summary>
        /// ComplexComponent PD 2nd Floor
        /// </summary>
        SLRCUser.PublicDisplays.PD2ndFloor.IPD2ndFloor PD2ndFloor { get; }

        /// <summary>
        /// ComplexComponent PD 3rd Floor
        /// </summary>
        SLRCUser.PublicDisplays.PD3rdFloor.IPD3rdFloor PD3rdFloor { get; }
    ...
    internal partial class PublicDisplays : IPublicDisplays, IDisposable
    {
        ...
        private void Initialize(uint controlJoinId, uint? itemCount)
        {
            ...
            Header = new SLRCUser.PublicDisplays.Header(ComponentMediator, 75);
            PageSelectTabButton = new SLRCUser.PublicDisplays.PageSelectTabButton(ComponentMediator, 76);
            PDRouting = new SLRCUser.PublicDisplays.PDRouting(ComponentMediator, 77);
            PDLowerLevel = new SLRCUser.PublicDisplays.PDLowerLevel.PDLowerLevel(ComponentMediator, 78);
            PD1stFloor = new SLRCUser.PublicDisplays.PD1stFloor.PD1stFloor(ComponentMediator, 85);
            PD2ndFloor = new SLRCUser.PublicDisplays.PD2ndFloor.PD2ndFloor(ComponentMediator, 93);
            PD3rdFloor = new SLRCUser.PublicDisplays.PD3rdFloor.PD3rdFloor(ComponentMediator, 97);
            BuildingMute = new SLRCUser.PublicDisplays.BuildingMute(ComponentMediator, 102);
        }
        ...
        public void AddDevice(BasicTriListWithSmartObject device)
        {
            ...
            ((SLRCUser.PublicDisplays.PDRouting)PDRouting).AddDevice(device);

            ((SLRCUser.PublicDisplays.PDLowerLevel.PDLowerLevel)PDLowerLevel).AddDevice(device);

            ((SLRCUser.PublicDisplays.PD1stFloor.PD1stFloor)PD1stFloor).AddDevice(device);

            ((SLRCUser.PublicDisplays.PD2ndFloor.PD2ndFloor)PD2ndFloor).AddDevice(device);

            ((SLRCUser.PublicDisplays.PD3rdFloor.PD3rdFloor)PD3rdFloor).AddDevice(device);
        ...
        ((SLRCUser.PublicDisplays.PDRouting)PDRouting).RemoveDevice(device);

        ((SLRCUser.PublicDisplays.PDLowerLevel.PDLowerLevel)PDLowerLevel).RemoveDevice(device);

        ((SLRCUser.PublicDisplays.PD1stFloor.PD1stFloor)PD1stFloor).RemoveDevice(device);

        ((SLRCUser.PublicDisplays.PD2ndFloor.PD2ndFloor)PD2ndFloor).RemoveDevice(device);

        ((SLRCUser.PublicDisplays.PD3rdFloor.PD3rdFloor)PD3rdFloor).RemoveDevice(device);
        ...
        /// ComplexComponent PD Routing
        /// </summary>
        public SLRCUser.PublicDisplays.IPDRouting PDRouting { get; private set; }

        /// <summary>
        /// ComplexComponent PD Lower Level
        /// </summary>
        public SLRCUser.PublicDisplays.PDLowerLevel.IPDLowerLevel PDLowerLevel { get; private set; }

        /// <summary>
        /// ComplexComponent PD 1st Floor
        /// </summary>
        public SLRCUser.PublicDisplays.PD1stFloor.IPD1stFloor PD1stFloor { get; private set; }

        /// <summary>
        /// ComplexComponent PD 2nd Floor
        /// </summary>
        public SLRCUser.PublicDisplays.PD2ndFloor.IPD2ndFloor PD2ndFloor { get; private set; }

        /// <summary>
        /// ComplexComponent PD 3rd Floor
        /// </summary>
        public SLRCUser.PublicDisplays.PD3rdFloor.IPD3rdFloor PD3rdFloor { get; private set; }
