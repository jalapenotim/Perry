...
namespace SLRCUser.CableTV
{
    ...
    public partial interface IHeader 
    {
        ...
        /// <summary>
        /// Event CableTV.Header.Lock Button.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> LockButton_PressEvent;

        /// <summary>
        /// Event CableTV.Header.Main Page Button.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> MainPageButton_PressEvent;

        /// <summary>
        /// CableTV.Header.Main Page Button.Visibility Feedback
        /// </summary>
        ...
        /// <summary>
        /// CableTV.Header.Page Name Text.Indirect Rich Text Feedback
        /// </summary>
    ...
    internal partial class Header : IHeader, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: CableTV.Header.LockButton.Press
                /// CableTV.Header.Lock Button.Press
                /// </summary>
                public const uint LockButton_PressEvent = 2;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: CableTV.Header.MainPageButton.Press
                /// CableTV.Header.Main Page Button.Press
                /// </summary>
                public const uint MainPageButton_PressEvent = 3;


                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: CableTV.Header.MainPageButton.Visibility_fb
                /// CableTV.Header.Main Page Button.Visibility
                /// </summary>
            ...
            internal static class Strings
            {
                ...
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: CableTV.Header.PageNameText.IndirectRichText
                /// CableTV.Header.Page Name Text.Indirect Rich Text
                /// </summary>
