...
namespace SLRCUser.Main
{
    ...
    public partial interface IMain
    {
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void VisibilityJoin(MainBoolInputSigDelegate callback);

        /// <summary>
        /// ComplexComponent Header
        /// </summary>
        SLRCUser.Main.IHeader Header { get; }

        /// <summary>
        /// ComplexComponent Building Mute
        /// </summary>
        SLRCUser.Main.IBuildingMute BuildingMute { get; }
    }
    ...
    internal partial class Main : IMain, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            internal static class Booleans
            {
                ...
                /// Main.VisibilityJoin
                /// </summary>
                public const uint VisibilityJoinState = 8;
        ...
        private void Initialize(uint controlJoinId, uint? itemCount)
        {
            ...
            Header = new SLRCUser.Main.Header(ComponentMediator, 47);
            BuildingMute = new SLRCUser.Main.BuildingMute(ComponentMediator, 48);
        }
        ...
        public void AddDevice(BasicTriListWithSmartObject device)
        {
            ...
            ((SLRCUser.Main.Header)Header).AddDevice(device);

            ((SLRCUser.Main.BuildingMute)BuildingMute).AddDevice(device);
        }
        ...
        ((SLRCUser.Main.Header)Header).RemoveDevice(device);

        ((SLRCUser.Main.BuildingMute)BuildingMute).RemoveDevice(device);
        }
        ...
        /// <inheritdoc/>
        public void VisibilityJoin(MainBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// ComplexComponent Header
        /// </summary>
        public SLRCUser.Main.IHeader Header { get; private set; }

        /// <summary>
        /// ComplexComponent Building Mute
        /// </summary>
        public SLRCUser.Main.IBuildingMute BuildingMute { get; private set; }
