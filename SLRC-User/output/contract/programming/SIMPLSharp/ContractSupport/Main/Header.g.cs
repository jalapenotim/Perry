...
namespace SLRCUser.Main
{
    ...
    public partial interface IHeader 
    {
        ...
        /// <summary>
        /// Event Main.Header.Lock Button.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> LockButton_PressEvent;

        /// <summary>
        /// Event Main.Header.Main Page Button.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> MainPageButton_PressEvent;

        /// <summary>
        /// Main.Header.Main Page Button.Visibility Feedback
        /// </summary>
        ...
        /// <summary>
        /// Main.Header.Page Name Text.Indirect Rich Text Feedback
        /// </summary>
    ...
    internal partial class Header : IHeader, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Main.Header.LockButton.Press
                /// Main.Header.Lock Button.Press
                /// </summary>
                public const uint LockButton_PressEvent = 2;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Main.Header.MainPageButton.Press
                /// Main.Header.Main Page Button.Press
                /// </summary>
                public const uint MainPageButton_PressEvent = 3;


                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Main.Header.MainPageButton.Visibility_fb
                /// Main.Header.Main Page Button.Visibility
                /// </summary>
            ...
            internal static class Strings
            {
                ...
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: Main.Header.PageNameText.IndirectRichText
                /// Main.Header.Page Name Text.Indirect Rich Text
                /// </summary>
