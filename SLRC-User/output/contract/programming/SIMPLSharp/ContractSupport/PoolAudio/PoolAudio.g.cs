...
namespace SLRCUser.PoolAudio
{
    ...
    internal partial class PoolAudio : IPoolAudio, IDisposable
    {
        ...
        private void Initialize(uint controlJoinId, uint? itemCount)
        {
            ...
            OfficeWidgetList = new SLRCUser.PoolAudio.OfficeWidgetList.OfficeWidgetList(ComponentMediator, 3);
            BoothWidgetList = new SLRCUser.PoolAudio.BoothWidgetList.BoothWidgetList(ComponentMediator, 6);
            BuildingProgramWidget = new SLRCUser.PoolAudio.BuildingProgramWidget(ComponentMediator, 9);
            BuildingMute = new SLRCUser.PoolAudio.BuildingMute(ComponentMediator, 10);
        }
