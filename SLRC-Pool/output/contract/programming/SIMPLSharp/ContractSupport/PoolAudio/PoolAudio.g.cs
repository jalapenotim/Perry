...
namespace SLRCPool.PoolAudio
{
    ...
    internal partial class PoolAudio : IPoolAudio, IDisposable
    {
        ...
        private void Initialize(uint controlJoinId, uint? itemCount)
        {
            ...
            BoothWidgetList = new SLRCPool.PoolAudio.BoothWidgetList.BoothWidgetList(ComponentMediator, 4);
            OfficeWidgetList = new SLRCPool.PoolAudio.OfficeWidgetList.OfficeWidgetList(ComponentMediator, 7);
            BuildingMute = new SLRCPool.PoolAudio.BuildingMute(ComponentMediator, 10);
            Header = new SLRCPool.PoolAudio.Header(ComponentMediator, 11);
            BuildingProgramWidget = new SLRCPool.PoolAudio.BuildingProgramWidget(ComponentMediator, 13);
        }
