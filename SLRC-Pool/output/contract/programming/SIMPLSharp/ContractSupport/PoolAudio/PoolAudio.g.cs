...
namespace SLRCPool.PoolAudio
{
    ...
    public partial interface IPoolAudio
    {
        ...
        /// </summary>
        SLRCPool.PoolAudio.IHeader Header { get; }

        /// <summary>
        /// ComplexComponent Office Widget List
        /// </summary>
        SLRCPool.PoolAudio.OfficeWidgetList.IOfficeWidgetList OfficeWidgetList { get; }

        /// <summary>
        /// ComplexComponent Booth Widget List
        /// </summary>
        SLRCPool.PoolAudio.BoothWidgetList.IBoothWidgetList BoothWidgetList { get; }

        /// <summary>
        /// ComplexComponent Building Program Widget
        /// </summary>
        SLRCPool.PoolAudio.IBuildingProgramWidget BuildingProgramWidget { get; }

        /// <summary>
        /// ComplexComponent Building Mute
        /// </summary>
        SLRCPool.PoolAudio.IBuildingMute BuildingMute { get; }
    }
    ...
    internal partial class PoolAudio : IPoolAudio, IDisposable
    {
        ...
        private void Initialize(uint controlJoinId, uint? itemCount)
        {
            ...
            Header = new SLRCPool.PoolAudio.Header(ComponentMediator, 3);
            OfficeWidgetList = new SLRCPool.PoolAudio.OfficeWidgetList.OfficeWidgetList(ComponentMediator, 4);
            BoothWidgetList = new SLRCPool.PoolAudio.BoothWidgetList.BoothWidgetList(ComponentMediator, 7);
            BuildingProgramWidget = new SLRCPool.PoolAudio.BuildingProgramWidget(ComponentMediator, 10);
            BuildingMute = new SLRCPool.PoolAudio.BuildingMute(ComponentMediator, 11);
        }
        ...
        public void AddDevice(BasicTriListWithSmartObject device)
        {
            ...
            ((SLRCPool.PoolAudio.Header)Header).AddDevice(device);

            ((SLRCPool.PoolAudio.OfficeWidgetList.OfficeWidgetList)OfficeWidgetList).AddDevice(device);

            ((SLRCPool.PoolAudio.BoothWidgetList.BoothWidgetList)BoothWidgetList).AddDevice(device);

            ((SLRCPool.PoolAudio.BuildingProgramWidget)BuildingProgramWidget).AddDevice(device);

            ((SLRCPool.PoolAudio.BuildingMute)BuildingMute).AddDevice(device);
        }
        ...
        ((SLRCPool.PoolAudio.Header)Header).RemoveDevice(device);

        ((SLRCPool.PoolAudio.OfficeWidgetList.OfficeWidgetList)OfficeWidgetList).RemoveDevice(device);

        ((SLRCPool.PoolAudio.BoothWidgetList.BoothWidgetList)BoothWidgetList).RemoveDevice(device);

        ((SLRCPool.PoolAudio.BuildingProgramWidget)BuildingProgramWidget).RemoveDevice(device);

        ((SLRCPool.PoolAudio.BuildingMute)BuildingMute).RemoveDevice(device);
        }
        ...
        /// ComplexComponent Header
        /// </summary>
        public SLRCPool.PoolAudio.IHeader Header { get; private set; }

        /// <summary>
        /// ComplexComponent Office Widget List
        /// </summary>
        public SLRCPool.PoolAudio.OfficeWidgetList.IOfficeWidgetList OfficeWidgetList { get; private set; }

        /// <summary>
        /// ComplexComponent Booth Widget List
        /// </summary>
        public SLRCPool.PoolAudio.BoothWidgetList.IBoothWidgetList BoothWidgetList { get; private set; }

        /// <summary>
        /// ComplexComponent Building Program Widget
        /// </summary>
        public SLRCPool.PoolAudio.IBuildingProgramWidget BuildingProgramWidget { get; private set; }

        /// <summary>
        /// ComplexComponent Building Mute
        /// </summary>
        public SLRCPool.PoolAudio.IBuildingMute BuildingMute { get; private set; }
