...
namespace SLRCPool.PoolAudio
{
    ...
    public partial interface IHeader 
    {
        ...
        /// <summary>
        /// Event PoolAudio.Header.Lock Button.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> LockButton_PressEvent;

        /// <summary>
        /// Event PoolAudio.Header.Main Page Button.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> MainPageButton_PressEvent;

        /// <summary>
        /// PoolAudio.Header.Lock Button.Visibility Feedback
        /// </summary>
        ...
        /// <summary>
        /// PoolAudio.Header.Main Page Button.Visibility Feedback
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        ...
        /// <summary>
        /// PoolAudio.Header.Page Name Text.Indirect Rich Text Feedback
        /// </summary>
    ...
    internal partial class Header : IHeader, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: PoolAudio.Header.LockButton.Press
                /// PoolAudio.Header.Lock Button.Press
                /// </summary>
                public const uint LockButton_PressEvent = 2;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: PoolAudio.Header.MainPageButton.Press
                /// PoolAudio.Header.Main Page Button.Press
                /// </summary>
                public const uint MainPageButton_PressEvent = 3;


                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: PoolAudio.Header.LockButton.Visibility_fb
                /// PoolAudio.Header.Lock Button.Visibility
                /// </summary>
                public const uint LockButton_Visibility_fbState = 1;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: PoolAudio.Header.MainPageButton.Visibility_fb
                /// PoolAudio.Header.Main Page Button.Visibility
                /// </summary>
            ...
            internal static class Strings
            {
                ...
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: PoolAudio.Header.PageNameText.IndirectRichText
                /// PoolAudio.Header.Page Name Text.Indirect Rich Text
                /// </summary>
