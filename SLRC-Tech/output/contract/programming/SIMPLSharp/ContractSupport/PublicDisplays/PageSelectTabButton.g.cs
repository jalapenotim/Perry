...
namespace SLRCTech.PublicDisplays
{
    ...
    /// </summary>
    public partial interface IPageSelectTabButtonByItem
    {
        /// <summary>
        ...
        void Tab_Selected(ushort tabIndex, PageSelectTabButtonBoolInputSigDelegate callback);
    }
    ...
    /// Search List
    /// </summary>
    internal partial class PageSelectTabButton
    {
        #region CH5 Contract
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        public void Tab_Selected(ushort tabIndex, PageSelectTabButtonBoolInputSigDelegate callback)
        {
    ...
    /// <summary>
    /// Page Select Tab Button
    /// </summary>
    public partial interface IPageSelectTabButton : IPageSelectTabButtonByItem
    {
        ...
        void Tab_1_Item_Selected(PageSelectTabButtonBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Tab_2_Item_Selected(PageSelectTabButtonBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Tab_3_Item_Selected(PageSelectTabButtonBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Tab_4_Item_Selected(PageSelectTabButtonBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Tab_5_Item_Selected(PageSelectTabButtonBoolInputSigDelegate callback);
    }
    ...
    /// <param name="pageselecttabbutton">The <see cref="IPageSelectTabButton"/> on which to apply the feedback.</param>
    public delegate void PageSelectTabButtonBoolInputSigDelegate(BoolInputSig boolInputSig, IPageSelectTabButton pageselecttabbutton);

    /// <summary>
    /// Page Select Tab Button
    /// </summary>
    internal partial class PageSelectTabButton : IPageSelectTabButton, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: PublicDisplays.PageSelectTabButton.Tab1_Press
                /// Tab1._Press
                /// </summary>
                public const uint Tab_1_Item_PressEvent = 31;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: PublicDisplays.PageSelectTabButton.Tab2_Press
                /// Tab2._Press
                /// </summary>
                public const uint Tab_2_Item_PressEvent = 32;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: PublicDisplays.PageSelectTabButton.Tab3_Press
                /// Tab3._Press
                /// </summary>
                public const uint Tab_3_Item_PressEvent = 33;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: PublicDisplays.PageSelectTabButton.Tab4_Press
                /// Tab4._Press
                /// </summary>
                public const uint Tab_4_Item_PressEvent = 34;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: PublicDisplays.PageSelectTabButton.Tab5_Press
                /// Tab5._Press
                /// </summary>
                ...
                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: PublicDisplays.PageSelectTabButton.Tab1_Selected
                /// Tab1._Selected
                /// </summary>
                public const uint Tab_1_Item_SelectedState = 31;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: PublicDisplays.PageSelectTabButton.Tab2_Selected
                /// Tab2._Selected
                /// </summary>
                public const uint Tab_2_Item_SelectedState = 32;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: PublicDisplays.PageSelectTabButton.Tab3_Selected
                /// Tab3._Selected
                /// </summary>
                public const uint Tab_3_Item_SelectedState = 33;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: PublicDisplays.PageSelectTabButton.Tab4_Selected
                /// Tab4._Selected
                /// </summary>
                public const uint Tab_4_Item_SelectedState = 34;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: PublicDisplays.PageSelectTabButton.Tab5_Selected
                /// Tab5._Selected
                /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PageSelectTabButton"/> component class.
        /// </summary>
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        /// <param name="itemCount">The number of items.</param>
        internal PageSelectTabButton(ComponentMediator componentMediator, uint controlJoinId, uint? itemCount)
        {
        ...
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        internal PageSelectTabButton(ComponentMediator componentMediator, uint controlJoinId) : this(componentMediator, controlJoinId, null)
        {
        }
        ...
        private Indexes GetIndexes(uint controlJoinId, uint join, eSigType eSigType)
        {
            if (controlJoinId == ControlJoinId &&
                ...
                join <= Joins.Booleans.Tab_5_Item_PressEvent)
            {
        ...
        /// <inheritdoc/>
        public void Tab_2_Item_Selected(PageSelectTabButtonBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Tab_3_Item_Selected(PageSelectTabButtonBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Tab_4_Item_Selected(PageSelectTabButtonBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Tab_5_Item_Selected(PageSelectTabButtonBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        {
            return string.Format("Contract: {0} Component: {1} HashCode: {2} {3}", "PageSelectTabButton", GetType().Name, GetHashCode(), UserObject != null ? "UserObject: " + UserObject : null);
        }
