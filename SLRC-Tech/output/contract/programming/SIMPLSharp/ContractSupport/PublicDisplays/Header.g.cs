...
namespace SLRCTech.PublicDisplays
{
    ...
    public partial interface IHeader 
    {
        ...
        /// <summary>
        /// Event PublicDisplays.Header.Lock Button.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> LockButton_PressEvent;

        /// <summary>
        /// Event PublicDisplays.Header.Main Page Button.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> MainPageButton_PressEvent;

        /// <summary>
        /// PublicDisplays.Header.Main Page Button.Visibility Feedback
        /// </summary>
        ...
        /// <summary>
        /// PublicDisplays.Header.Page Name Text.Indirect Rich Text Feedback
        /// </summary>
    ...
    internal partial class Header : IHeader, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: PublicDisplays.Header.LockButton.Press
                /// PublicDisplays.Header.Lock Button.Press
                /// </summary>
                public const uint LockButton_PressEvent = 2;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: PublicDisplays.Header.MainPageButton.Press
                /// PublicDisplays.Header.Main Page Button.Press
                /// </summary>
                public const uint MainPageButton_PressEvent = 3;


                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: PublicDisplays.Header.MainPageButton.Visibility_fb
                /// PublicDisplays.Header.Main Page Button.Visibility
                /// </summary>
            ...
            internal static class Strings
            {
                ...
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: PublicDisplays.Header.PageNameText.IndirectRichText
                /// PublicDisplays.Header.Page Name Text.Indirect Rich Text
                /// </summary>
