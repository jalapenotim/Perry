...
namespace SLRCTech.PublicDisplays
{
    ...
    public partial interface IBuildingMute 
    {
        ...
        /// <summary>
        /// Event PublicDisplays.BuildingMute.Mute Off Button.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> MuteOffButton_PressEvent;

        /// <summary>
        /// Event PublicDisplays.BuildingMute.Mute On Button.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> MuteOnButton_PressEvent;

        /// <summary>
        /// PublicDisplays.BuildingMute.Building Mute Status.Visibility Feedback
        /// </summary>
        ...
        /// <summary>
        /// PublicDisplays.BuildingMute.Mute Off Button.Enable Feedback
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        ...
        /// <summary>
        /// PublicDisplays.BuildingMute.Mute On Button.Enable Feedback
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        ...
        /// <summary>
        /// PublicDisplays.BuildingMute.Mute Off Button.Selected Feedback
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        ...
        /// <summary>
        /// PublicDisplays.BuildingMute.Mute On Button.Selected Feedback
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        ...
        /// <summary>
        /// PublicDisplays.BuildingMute.Building Mute Status.Indirect Rich Text Feedback
        /// </summary>
        ...
        /// <summary>
        /// PublicDisplays.BuildingMute.Building Mute Text.Indirect Rich Text Feedback
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
    ...
    internal partial class BuildingMute : IBuildingMute, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: PublicDisplays.BuildingMute.MuteOffButton.Press
                /// PublicDisplays.BuildingMute.Mute Off Button.Press
                /// </summary>
                public const uint MuteOffButton_PressEvent = 1;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: PublicDisplays.BuildingMute.MuteOnButton.Press
                /// PublicDisplays.BuildingMute.Mute On Button.Press
                /// </summary>
                public const uint MuteOnButton_PressEvent = 2;


                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: PublicDisplays.BuildingMute.BuildingMuteStatus.Visibility_fb
                /// PublicDisplays.BuildingMute.Building Mute Status.Visibility
                /// </summary>
                public const uint BuildingMuteStatus_Visibility_fbState = 1;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: PublicDisplays.BuildingMute.MuteOffButton.Enable
                /// PublicDisplays.BuildingMute.Mute Off Button.Enable
                /// </summary>
                public const uint MuteOffButton_EnableState = 2;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: PublicDisplays.BuildingMute.MuteOnButton.Enable
                /// PublicDisplays.BuildingMute.Mute On Button.Enable
                /// </summary>
                public const uint MuteOnButton_EnableState = 3;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: PublicDisplays.BuildingMute.MuteOffButton.Selected
                /// PublicDisplays.BuildingMute.Mute Off Button.Selected
                /// </summary>
                public const uint MuteOffButton_SelectedState = 4;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: PublicDisplays.BuildingMute.MuteOnButton.Selected
                /// PublicDisplays.BuildingMute.Mute On Button.Selected
                /// </summary>
            ...
            internal static class Strings
            {
                ...
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: PublicDisplays.BuildingMute.BuildingMuteStatus.IndirectRichText
                /// PublicDisplays.BuildingMute.Building Mute Status.Indirect Rich Text
                /// </summary>
                public const uint BuildingMuteStatus_IndirectRichTextState = 1;
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: PublicDisplays.BuildingMute.BuildingMuteText.IndirectRichText
                /// PublicDisplays.BuildingMute.Building Mute Text.Indirect Rich Text
                /// </summary>
