...
namespace SLRCTech.CableTV
{
    ...
    /// </summary>
    public partial interface IDpadByItem
    {
        /// <summary>
    ...
    /// Dpad
    /// </summary>
    public partial interface IDpad : IDpadByItem
    {
        object UserObject { get; set; }

        /// <summary>
        /// Event Up.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> UpEvent;

        /// <summary>
        /// Event Down.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> DownEvent;

        /// <summary>
        /// Event Left.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> LeftEvent;

        /// <summary>
        /// Event Right.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> RightEvent;

        /// <summary>
        /// Event Center.Press (from panel to Control System)
        /// </summary>
    ...
    internal partial class Dpad : IDpad, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: CableTV.Dpad.Up
                /// Up.Press
                /// </summary>
                public const uint UpEvent = 3;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: CableTV.Dpad.Down
                /// Down.Press
                /// </summary>
                public const uint DownEvent = 4;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: CableTV.Dpad.Left
                /// Left.Press
                /// </summary>
                public const uint LeftEvent = 5;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: CableTV.Dpad.Right
                /// Right.Press
                /// </summary>
                public const uint RightEvent = 6;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: CableTV.Dpad.Center
                /// Center.Press
                /// </summary>
