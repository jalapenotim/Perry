...
namespace SLRCTech.CableTV
{
    ...
    /// </summary>
    public partial interface IVolumeTabButtonByItem
    {
        /// <summary>
    ...
    /// Search List
    /// </summary>
    internal partial class VolumeTabButton
    {
        #region CH5 Contract
        /// <inheritdoc/>
    ...
    /// Volume Tab Button
    /// </summary>
    public partial interface IVolumeTabButton : IVolumeTabButtonByItem
    {
    ...
    /// <param name="volumetabbutton">The <see cref="IVolumeTabButton"/> on which to apply the feedback.</param>
    public delegate void VolumeTabButtonBoolInputSigDelegate(BoolInputSig boolInputSig, IVolumeTabButton volumetabbutton);

    /// <summary>
    /// Volume Tab Button
    /// </summary>
    internal partial class VolumeTabButton : IVolumeTabButton, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: CableTV.VolumeTabButton.Tab1_Press
                /// Tab1._Press
                /// </summary>
                public const uint Tab_1_Item_PressEvent = 31;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: CableTV.VolumeTabButton.Tab2_Press
                /// Tab2._Press
                /// </summary>
                public const uint Tab_2_Item_PressEvent = 32;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: CableTV.VolumeTabButton.Tab3_Press
                /// Tab3._Press
                /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VolumeTabButton"/> component class.
        /// </summary>
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        /// <param name="itemCount">The number of items.</param>
        internal VolumeTabButton(ComponentMediator componentMediator, uint controlJoinId, uint? itemCount)
        {
        ...
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        internal VolumeTabButton(ComponentMediator componentMediator, uint controlJoinId) : this(componentMediator, controlJoinId, null)
        {
        }
        ...
        {
            return string.Format("Contract: {0} Component: {1} HashCode: {2} {3}", "VolumeTabButton", GetType().Name, GetHashCode(), UserObject != null ? "UserObject: " + UserObject : null);
        }
