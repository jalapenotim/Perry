...
namespace SLRCTech.CableTV
{
    ...
    /// </summary>
    public partial interface IMenuTabButtonByItem
    {
        /// <summary>
    ...
    /// Search List
    /// </summary>
    internal partial class MenuTabButton
    {
        #region CH5 Contract
        /// <inheritdoc/>
    ...
    /// Menu Tab Button
    /// </summary>
    public partial interface IMenuTabButton : IMenuTabButtonByItem
    {
    ...
    /// <param name="menutabbutton">The <see cref="IMenuTabButton"/> on which to apply the feedback.</param>
    public delegate void MenuTabButtonBoolInputSigDelegate(BoolInputSig boolInputSig, IMenuTabButton menutabbutton);

    /// <summary>
    /// Menu Tab Button
    /// </summary>
    internal partial class MenuTabButton : IMenuTabButton, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: CableTV.MenuTabButton.Tab1_Press
                /// Tab1._Press
                /// </summary>
                public const uint Tab_1_Item_PressEvent = 31;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: CableTV.MenuTabButton.Tab2_Press
                /// Tab2._Press
                /// </summary>
                public const uint Tab_2_Item_PressEvent = 32;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: CableTV.MenuTabButton.Tab3_Press
                /// Tab3._Press
                /// </summary>
                public const uint Tab_3_Item_PressEvent = 33;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: CableTV.MenuTabButton.Tab4_Press
                /// Tab4._Press
                /// </summary>
                public const uint Tab_4_Item_PressEvent = 34;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: CableTV.MenuTabButton.Tab5_Press
                /// Tab5._Press
                /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MenuTabButton"/> component class.
        /// </summary>
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        /// <param name="itemCount">The number of items.</param>
        internal MenuTabButton(ComponentMediator componentMediator, uint controlJoinId, uint? itemCount)
        {
        ...
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        internal MenuTabButton(ComponentMediator componentMediator, uint controlJoinId) : this(componentMediator, controlJoinId, null)
        {
        }
        ...
        {
            return string.Format("Contract: {0} Component: {1} HashCode: {2} {3}", "MenuTabButton", GetType().Name, GetHashCode(), UserObject != null ? "UserObject: " + UserObject : null);
        }
