...
namespace SLRCTech.FieldhouseAudio
{
    ...
    /// </summary>
    public partial interface IZonesTabButtonByItem
    {
        /// <summary>
        ...
        void Tab_Selected(ushort tabIndex, ZonesTabButtonBoolInputSigDelegate callback);
    }
    ...
    /// Search List
    /// </summary>
    internal partial class ZonesTabButton
    {
        #region CH5 Contract
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        public void Tab_Selected(ushort tabIndex, ZonesTabButtonBoolInputSigDelegate callback)
        {
    ...
    /// Zones Tab Button
    /// </summary>
    public partial interface IZonesTabButton : IZonesTabButtonByItem
    {
        ...
        void Tab_1_Item_Selected(ZonesTabButtonBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Tab_2_Item_Selected(ZonesTabButtonBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Tab_3_Item_Selected(ZonesTabButtonBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Tab_4_Item_Selected(ZonesTabButtonBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Tab_5_Item_Selected(ZonesTabButtonBoolInputSigDelegate callback);
    }
    ...
    /// <param name="zonestabbutton">The <see cref="IZonesTabButton"/> on which to apply the feedback.</param>
    public delegate void ZonesTabButtonBoolInputSigDelegate(BoolInputSig boolInputSig, IZonesTabButton zonestabbutton);

    /// <summary>
    /// Zones Tab Button
    /// </summary>
    internal partial class ZonesTabButton : IZonesTabButton, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: FieldhouseAudio.ZonesTabButton.Tab1_Press
                /// Tab1._Press
                /// </summary>
                public const uint Tab_1_Item_PressEvent = 31;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: FieldhouseAudio.ZonesTabButton.Tab2_Press
                /// Tab2._Press
                /// </summary>
                public const uint Tab_2_Item_PressEvent = 32;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: FieldhouseAudio.ZonesTabButton.Tab3_Press
                /// Tab3._Press
                /// </summary>
                public const uint Tab_3_Item_PressEvent = 33;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: FieldhouseAudio.ZonesTabButton.Tab4_Press
                /// Tab4._Press
                /// </summary>
                public const uint Tab_4_Item_PressEvent = 34;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: FieldhouseAudio.ZonesTabButton.Tab5_Press
                /// Tab5._Press
                /// </summary>
                ...
                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: FieldhouseAudio.ZonesTabButton.Tab1_Selected
                /// Tab1._Selected
                /// </summary>
                public const uint Tab_1_Item_SelectedState = 31;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: FieldhouseAudio.ZonesTabButton.Tab2_Selected
                /// Tab2._Selected
                /// </summary>
                public const uint Tab_2_Item_SelectedState = 32;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: FieldhouseAudio.ZonesTabButton.Tab3_Selected
                /// Tab3._Selected
                /// </summary>
                public const uint Tab_3_Item_SelectedState = 33;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: FieldhouseAudio.ZonesTabButton.Tab4_Selected
                /// Tab4._Selected
                /// </summary>
                public const uint Tab_4_Item_SelectedState = 34;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: FieldhouseAudio.ZonesTabButton.Tab5_Selected
                /// Tab5._Selected
                /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ZonesTabButton"/> component class.
        /// </summary>
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        /// <param name="itemCount">The number of items.</param>
        internal ZonesTabButton(ComponentMediator componentMediator, uint controlJoinId, uint? itemCount)
        {
        ...
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        internal ZonesTabButton(ComponentMediator componentMediator, uint controlJoinId) : this(componentMediator, controlJoinId, null)
        {
        }
        ...
        /// <inheritdoc/>
        public void Tab_1_Item_Selected(ZonesTabButtonBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Tab_2_Item_Selected(ZonesTabButtonBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Tab_3_Item_Selected(ZonesTabButtonBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Tab_4_Item_Selected(ZonesTabButtonBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Tab_5_Item_Selected(ZonesTabButtonBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        {
            return string.Format("Contract: {0} Component: {1} HashCode: {2} {3}", "ZonesTabButton", GetType().Name, GetHashCode(), UserObject != null ? "UserObject: " + UserObject : null);
        }
