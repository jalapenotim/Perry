...
namespace SLRCTech.BackgroundMusic
{
    ...
    public partial interface IHeader 
    {
        ...
        /// <summary>
        /// Event BackgroundMusic.Header.Lock Button.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> LockButton_PressEvent;

        /// <summary>
        /// Event BackgroundMusic.Header.Main Page Button.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> MainPageButton_PressEvent;

        /// <summary>
        /// BackgroundMusic.Header.Main Page Button.Visibility Feedback
        /// </summary>
        ...
        /// <summary>
        /// BackgroundMusic.Header.Page Name Text.Indirect Rich Text Feedback
        /// </summary>
    ...
    internal partial class Header : IHeader, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: BackgroundMusic.Header.LockButton.Press
                /// BackgroundMusic.Header.Lock Button.Press
                /// </summary>
                public const uint LockButton_PressEvent = 2;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: BackgroundMusic.Header.MainPageButton.Press
                /// BackgroundMusic.Header.Main Page Button.Press
                /// </summary>
                public const uint MainPageButton_PressEvent = 3;


                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: BackgroundMusic.Header.MainPageButton.Visibility_fb
                /// BackgroundMusic.Header.Main Page Button.Visibility
                /// </summary>
            ...
            internal static class Strings
            {
                ...
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: BackgroundMusic.Header.PageNameText.IndirectRichText
                /// BackgroundMusic.Header.Page Name Text.Indirect Rich Text
                /// </summary>
