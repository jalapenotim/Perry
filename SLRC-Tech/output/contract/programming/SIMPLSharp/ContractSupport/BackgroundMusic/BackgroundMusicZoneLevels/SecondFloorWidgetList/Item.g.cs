...
namespace SLRCTech.BackgroundMusic.BackgroundMusicZoneLevels.SecondFloorWidgetList
{
    ...
    public partial interface IItemByItem
    {
        ...
        /// <param name="itemIndex">Index of the Widget List (0 based).</param>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
        void ZoneLevel_IndirectRichText(ushort itemIndex, ItemStringInputSigDelegate callback);
        ...
        /// <param name="itemIndex">Index of the Widget List (0 based).</param>
        /// <param name="serial">The <see cref="string"/> to update the panel.</param>
        void ZoneLevel_IndirectRichText(ushort itemIndex, string serial);
    }
    ...
    internal partial class Item
    {
        ...
        /// <summary>
        /// Boolean feedback BackgroundMusic.BackgroundMusicZoneLevels.SecondFloorWidgetList.Items[{0}].Zone Volume Mute Button.Selected (from Control System to Panel)
        /// </summary>
        ...
        /// <summary>
        /// Numeric feedback BackgroundMusic.BackgroundMusicZoneLevels.SecondFloorWidgetList.Items[{0}].Zone Volume Gauge.Lower Touch fb
        /// </summary>
        /// <param name="itemIndex">Index of the Widget List (0 based).</param>
        ...
        /// <inheritdoc/>
        public void ZoneLevel_IndirectRichText(ushort itemIndex, ItemStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
                callback(Devices[index].SmartObjects[ControlJoinId + itemIndex].StringInput[Joins.Strings.ZoneLevel_IndirectRichTextState], this);
            }
        }

        /// <inheritdoc/>
        public void ZoneLevel_IndirectRichText(ushort itemIndex, string serial)
        {
            ZoneLevel_IndirectRichText(itemIndex, (sig, component) => sig.StringValue = serial);
        }
