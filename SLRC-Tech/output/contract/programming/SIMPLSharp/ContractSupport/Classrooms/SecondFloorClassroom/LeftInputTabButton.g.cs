...
namespace SLRCTech.Classrooms.SecondFloorClassroom
{
    ...
    /// </summary>
    public partial interface ILeftInputTabButtonByItem
    {
        /// <summary>
        ...
        void Tab_Selected(ushort buttonIndex, LeftInputTabButtonBoolInputSigDelegate callback);
    ...
    /// Search List
    /// </summary>
    internal partial class LeftInputTabButton
    {
        #region CH5 Contract
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        public void Tab_Selected(ushort buttonIndex, LeftInputTabButtonBoolInputSigDelegate callback)
        {
    ...
    /// <summary>
    /// Left Input Tab Button
    /// </summary>
    public partial interface ILeftInputTabButton : ILeftInputTabButtonByItem
    {
        ...
        void Tab_1_Item_Selected(LeftInputTabButtonBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Tab_2_Item_Selected(LeftInputTabButtonBoolInputSigDelegate callback);
    ...
    /// <param name="leftinputtabbutton">The <see cref="ILeftInputTabButton"/> on which to apply the feedback.</param>
    public delegate void LeftInputTabButtonBoolInputSigDelegate(BoolInputSig boolInputSig, ILeftInputTabButton leftinputtabbutton);

    /// <summary>
    /// Left Input Tab Button
    /// </summary>
    internal partial class LeftInputTabButton : ILeftInputTabButton, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Classrooms.SecondFloorClassroom.LeftInputTabButton.Tab1_Press
                /// Classrooms.SecondFloorClassroom.Tab1._Press
                /// </summary>
                public const uint Tab_1_Item_PressEvent = 31;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Classrooms.SecondFloorClassroom.LeftInputTabButton.Tab2_Press
                ...
                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Classrooms.SecondFloorClassroom.LeftInputTabButton.Tab1_Selected
                /// Classrooms.SecondFloorClassroom.Tab1._Selected
                /// </summary>
                public const uint Tab_1_Item_SelectedState = 31;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Classrooms.SecondFloorClassroom.LeftInputTabButton.Tab2_Selected
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LeftInputTabButton"/> component class.
        /// </summary>
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        /// <param name="itemCount">The number of items.</param>
        internal LeftInputTabButton(ComponentMediator componentMediator, uint controlJoinId, uint? itemCount)
        {
        ...
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        internal LeftInputTabButton(ComponentMediator componentMediator, uint controlJoinId) : this(componentMediator, controlJoinId, null)
        {
        }
        ...
        /// <inheritdoc/>
        public void Tab_1_Item_Selected(LeftInputTabButtonBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Tab_2_Item_Selected(LeftInputTabButtonBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        {
            return string.Format("Contract: {0} Component: {1} HashCode: {2} {3}", "LeftInputTabButton", GetType().Name, GetHashCode(), UserObject != null ? "UserObject: " + UserObject : null);
        }
