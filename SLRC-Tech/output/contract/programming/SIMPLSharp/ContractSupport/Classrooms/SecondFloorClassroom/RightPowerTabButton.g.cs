...
namespace SLRCTech.Classrooms.SecondFloorClassroom
{
    ...
    /// </summary>
    public partial interface IRightPowerTabButtonByItem
    {
        /// <summary>
        ...
        void Tab_Selected(ushort buttonIndex, RightPowerTabButtonBoolInputSigDelegate callback);
    ...
    /// Search List
    /// </summary>
    internal partial class RightPowerTabButton
    {
        #region CH5 Contract
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        public void Tab_Selected(ushort buttonIndex, RightPowerTabButtonBoolInputSigDelegate callback)
        {
    ...
    /// <summary>
    /// Right Power Tab Button
    /// </summary>
    public partial interface IRightPowerTabButton : IRightPowerTabButtonByItem
    {
        ...
        void Tab_1_Item_Selected(RightPowerTabButtonBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Tab_2_Item_Selected(RightPowerTabButtonBoolInputSigDelegate callback);
    ...
    /// <param name="rightpowertabbutton">The <see cref="IRightPowerTabButton"/> on which to apply the feedback.</param>
    public delegate void RightPowerTabButtonBoolInputSigDelegate(BoolInputSig boolInputSig, IRightPowerTabButton rightpowertabbutton);

    /// <summary>
    /// Right Power Tab Button
    /// </summary>
    internal partial class RightPowerTabButton : IRightPowerTabButton, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Classrooms.SecondFloorClassroom.RightPowerTabButton.Tab1_Press
                /// Classrooms.SecondFloorClassroom.Tab1._Press
                /// </summary>
                public const uint Tab_1_Item_PressEvent = 31;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Classrooms.SecondFloorClassroom.RightPowerTabButton.Tab2_Press
                ...
                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Classrooms.SecondFloorClassroom.RightPowerTabButton.Tab1_Selected
                /// Classrooms.SecondFloorClassroom.Tab1._Selected
                /// </summary>
                public const uint Tab_1_Item_SelectedState = 31;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Classrooms.SecondFloorClassroom.RightPowerTabButton.Tab2_Selected
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RightPowerTabButton"/> component class.
        /// </summary>
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        /// <param name="itemCount">The number of items.</param>
        internal RightPowerTabButton(ComponentMediator componentMediator, uint controlJoinId, uint? itemCount)
        {
        ...
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        internal RightPowerTabButton(ComponentMediator componentMediator, uint controlJoinId) : this(componentMediator, controlJoinId, null)
        {
        }
        ...
        /// <inheritdoc/>
        public void Tab_1_Item_Selected(RightPowerTabButtonBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Tab_2_Item_Selected(RightPowerTabButtonBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        {
            return string.Format("Contract: {0} Component: {1} HashCode: {2} {3}", "RightPowerTabButton", GetType().Name, GetHashCode(), UserObject != null ? "UserObject: " + UserObject : null);
        }
