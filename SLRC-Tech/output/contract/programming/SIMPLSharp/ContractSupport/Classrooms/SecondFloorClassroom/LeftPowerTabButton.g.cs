...
namespace SLRCTech.Classrooms.SecondFloorClassroom
{
    ...
    /// </summary>
    public partial interface ILeftPowerTabButtonByItem
    {
        /// <summary>
        ...
        void Tab_Selected(ushort buttonIndex, LeftPowerTabButtonBoolInputSigDelegate callback);
    ...
    /// Search List
    /// </summary>
    internal partial class LeftPowerTabButton
    {
        #region CH5 Contract
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        public void Tab_Selected(ushort buttonIndex, LeftPowerTabButtonBoolInputSigDelegate callback)
        {
    ...
    /// <summary>
    /// Left Power Tab Button
    /// </summary>
    public partial interface ILeftPowerTabButton : ILeftPowerTabButtonByItem
    {
        ...
        void Tab_1_Item_Selected(LeftPowerTabButtonBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Tab_2_Item_Selected(LeftPowerTabButtonBoolInputSigDelegate callback);
    ...
    /// <param name="leftpowertabbutton">The <see cref="ILeftPowerTabButton"/> on which to apply the feedback.</param>
    public delegate void LeftPowerTabButtonBoolInputSigDelegate(BoolInputSig boolInputSig, ILeftPowerTabButton leftpowertabbutton);

    /// <summary>
    /// Left Power Tab Button
    /// </summary>
    internal partial class LeftPowerTabButton : ILeftPowerTabButton, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Classrooms.SecondFloorClassroom.LeftPowerTabButton.Tab1_Press
                /// Classrooms.SecondFloorClassroom.Tab1._Press
                /// </summary>
                public const uint Tab_1_Item_PressEvent = 31;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Classrooms.SecondFloorClassroom.LeftPowerTabButton.Tab2_Press
                ...
                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Classrooms.SecondFloorClassroom.LeftPowerTabButton.Tab1_Selected
                /// Classrooms.SecondFloorClassroom.Tab1._Selected
                /// </summary>
                public const uint Tab_1_Item_SelectedState = 31;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Classrooms.SecondFloorClassroom.LeftPowerTabButton.Tab2_Selected
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LeftPowerTabButton"/> component class.
        /// </summary>
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        /// <param name="itemCount">The number of items.</param>
        internal LeftPowerTabButton(ComponentMediator componentMediator, uint controlJoinId, uint? itemCount)
        {
        ...
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        internal LeftPowerTabButton(ComponentMediator componentMediator, uint controlJoinId) : this(componentMediator, controlJoinId, null)
        {
        }
        ...
        /// <inheritdoc/>
        public void Tab_1_Item_Selected(LeftPowerTabButtonBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Tab_2_Item_Selected(LeftPowerTabButtonBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        {
            return string.Format("Contract: {0} Component: {1} HashCode: {2} {3}", "LeftPowerTabButton", GetType().Name, GetHashCode(), UserObject != null ? "UserObject: " + UserObject : null);
        }
