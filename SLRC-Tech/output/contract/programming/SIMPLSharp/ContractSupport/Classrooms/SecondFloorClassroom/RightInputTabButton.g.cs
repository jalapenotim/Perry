...
namespace SLRCTech.Classrooms.SecondFloorClassroom
{
    ...
    /// </summary>
    public partial interface IRightInputTabButtonByItem
    {
        /// <summary>
        ...
        void Tab_Selected(ushort buttonIndex, RightInputTabButtonBoolInputSigDelegate callback);
    ...
    /// Search List
    /// </summary>
    internal partial class RightInputTabButton
    {
        #region CH5 Contract
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        public void Tab_Selected(ushort buttonIndex, RightInputTabButtonBoolInputSigDelegate callback)
        {
    ...
    /// <summary>
    /// Right Input Tab Button
    /// </summary>
    public partial interface IRightInputTabButton : IRightInputTabButtonByItem
    {
        ...
        void Tab_1_Item_Selected(RightInputTabButtonBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Tab_2_Item_Selected(RightInputTabButtonBoolInputSigDelegate callback);
    ...
    /// <param name="rightinputtabbutton">The <see cref="IRightInputTabButton"/> on which to apply the feedback.</param>
    public delegate void RightInputTabButtonBoolInputSigDelegate(BoolInputSig boolInputSig, IRightInputTabButton rightinputtabbutton);

    /// <summary>
    /// Right Input Tab Button
    /// </summary>
    internal partial class RightInputTabButton : IRightInputTabButton, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Classrooms.SecondFloorClassroom.RightInputTabButton.Tab1_Press
                /// Classrooms.SecondFloorClassroom.Tab1._Press
                /// </summary>
                public const uint Tab_1_Item_PressEvent = 31;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Classrooms.SecondFloorClassroom.RightInputTabButton.Tab2_Press
                ...
                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Classrooms.SecondFloorClassroom.RightInputTabButton.Tab1_Selected
                /// Classrooms.SecondFloorClassroom.Tab1._Selected
                /// </summary>
                public const uint Tab_1_Item_SelectedState = 31;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Classrooms.SecondFloorClassroom.RightInputTabButton.Tab2_Selected
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RightInputTabButton"/> component class.
        /// </summary>
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        /// <param name="itemCount">The number of items.</param>
        internal RightInputTabButton(ComponentMediator componentMediator, uint controlJoinId, uint? itemCount)
        {
        ...
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        internal RightInputTabButton(ComponentMediator componentMediator, uint controlJoinId) : this(componentMediator, controlJoinId, null)
        {
        }
        ...
        /// <inheritdoc/>
        public void Tab_1_Item_Selected(RightInputTabButtonBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Tab_2_Item_Selected(RightInputTabButtonBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        {
            return string.Format("Contract: {0} Component: {1} HashCode: {2} {3}", "RightInputTabButton", GetType().Name, GetHashCode(), UserObject != null ? "UserObject: " + UserObject : null);
        }
