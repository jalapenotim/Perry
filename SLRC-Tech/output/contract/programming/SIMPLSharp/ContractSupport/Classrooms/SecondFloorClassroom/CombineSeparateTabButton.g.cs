...
namespace SLRCTech.Classrooms.SecondFloorClassroom
{
    ...
    public partial interface ICombineSeparateTabButtonByItem
    {
        ...
        void Tab_Selected(ushort tabIndex, CombineSeparateTabButtonBoolInputSigDelegate callback);
    }
    ...
    internal partial class CombineSeparateTabButton
    {
        ...
        /// <inheritdoc/>
        public void Tab_Selected(ushort tabIndex, CombineSeparateTabButtonBoolInputSigDelegate callback)
        {
    ...
    internal partial class CombineSeparateTabButton : ICombineSeparateTabButton, IDisposable
    {
        ...
        private Indexes GetIndexes(uint controlJoinId, uint join, eSigType eSigType)
        {
            if (controlJoinId == ControlJoinId &&
                ...
                join <= Joins.Booleans.Tab_2_Item_PressEvent)
            {
