...
namespace SLRCTech.Classrooms.SecondFloorClassroom
{
    ...
    /// </summary>
    public partial interface ICombineSeparateTabButtonByItem
    {
        /// <summary>
        ...
        /// <summary>
        /// Classrooms.SecondFloorClassroom.Tab1._Selected Feedback
        /// </summary>
        /// <param name="buttonIndex">The index of the button (0 based).</param>
        /// <param name="callback">The delegate to set the feedback.</param>
        void Tab_Selected(ushort buttonIndex, CombineSeparateTabButtonBoolInputSigDelegate callback);

        /// <summary>
        /// Helper Classrooms.SecondFloorClassroom.Tab1._Selected Feedback
        /// </summary>
        /// <param name="buttonIndex">The index of the button (0 based).</param>
    ...
    /// Search List
    /// </summary>
    internal partial class CombineSeparateTabButton
    {
        #region CH5 Contract
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        public void Tab_Selected(ushort buttonIndex, CombineSeparateTabButtonBoolInputSigDelegate callback)
        {
    ...
    /// <summary>
    /// Combine Separate Tab Button
    /// </summary>
    public partial interface ICombineSeparateTabButton : ICombineSeparateTabButtonByItem
    {
        object UserObject { get; set; }

        /// <summary>
        /// Event Classrooms.SecondFloorClassroom.Tab1._Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> Tab_1_Item_PressEvent;

        /// <summary>
        /// Event Classrooms.SecondFloorClassroom.Tab2._Press (from panel to Control System)
        /// </summary>
        ...
        void Tab_1_Item_Selected(CombineSeparateTabButtonBoolInputSigDelegate callback);
        ...
        /// <summary>
        /// Classrooms.SecondFloorClassroom.Tab2._Selected Feedback
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Tab_2_Item_Selected(CombineSeparateTabButtonBoolInputSigDelegate callback);
    ...
    /// <param name="combineseparatetabbutton">The <see cref="ICombineSeparateTabButton"/> on which to apply the feedback.</param>
    public delegate void CombineSeparateTabButtonBoolInputSigDelegate(BoolInputSig boolInputSig, ICombineSeparateTabButton combineseparatetabbutton);

    /// <summary>
    /// Combine Separate Tab Button
    /// </summary>
    internal partial class CombineSeparateTabButton : ICombineSeparateTabButton, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Classrooms.SecondFloorClassroom.CombineSeparateTabButton.Tab1_Press
                /// Classrooms.SecondFloorClassroom.Tab1._Press
                /// </summary>
                public const uint Tab_1_Item_PressEvent = 31;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Classrooms.SecondFloorClassroom.CombineSeparateTabButton.Tab2_Press
                /// Classrooms.SecondFloorClassroom.Tab2._Press
                /// </summary>
                public const uint Tab_2_Item_PressEvent = 32;


                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Classrooms.SecondFloorClassroom.CombineSeparateTabButton.Tab1_Selected
                /// Classrooms.SecondFloorClassroom.Tab1._Selected
                /// </summary>
                public const uint Tab_1_Item_SelectedState = 31;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Classrooms.SecondFloorClassroom.CombineSeparateTabButton.Tab2_Selected
                /// Classrooms.SecondFloorClassroom.Tab2._Selected
                /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CombineSeparateTabButton"/> component class.
        /// </summary>
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        /// <param name="itemCount">The number of items.</param>
        internal CombineSeparateTabButton(ComponentMediator componentMediator, uint controlJoinId, uint? itemCount)
        {
        ...
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        internal CombineSeparateTabButton(ComponentMediator componentMediator, uint controlJoinId) : this(componentMediator, controlJoinId, null)
        {
        }
        ...
        /// <inheritdoc/>
        public void Tab_1_Item_Selected(CombineSeparateTabButtonBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Tab_2_Item_Selected(CombineSeparateTabButtonBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        {
            return string.Format("Contract: {0} Component: {1} HashCode: {2} {3}", "CombineSeparateTabButton", GetType().Name, GetHashCode(), UserObject != null ? "UserObject: " + UserObject : null);
        }
