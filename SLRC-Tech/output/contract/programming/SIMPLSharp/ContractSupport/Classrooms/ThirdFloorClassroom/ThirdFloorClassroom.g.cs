    ...
    internal partial class ThirdFloorClassroom : IThirdFloorClassroom, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            internal static class Strings
            {
                ...
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: Classrooms.ThirdFloorClassroomControlsCONTRACT.LeftRoomLabel.IndirectRichText
                /// Left Room Label.Indirect Rich Text
                /// </summary>
                public const uint LeftRoomLabel_IndirectRichTextState = 1;
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: Classrooms.ThirdFloorClassroomControlsCONTRACT.RightRoomLabel.IndirectRichText
        ...
        private void Initialize(uint controlJoinId, uint? itemCount)
        {
            ...
            RightInputTabButton = new SLRCTech.Classrooms.ThirdFloorClassroom.RightInputTabButton(ComponentMediator, 117);
            RightPowerTabButton = new SLRCTech.Classrooms.ThirdFloorClassroom.RightPowerTabButton(ComponentMediator, 118);
            LeftPowerTabButton = new SLRCTech.Classrooms.ThirdFloorClassroom.LeftPowerTabButton(ComponentMediator, 119);
            LeftInputTabButton = new SLRCTech.Classrooms.ThirdFloorClassroom.LeftInputTabButton(ComponentMediator, 120);
            CombineSeparateTabButton = new SLRCTech.Classrooms.ThirdFloorClassroom.CombineSeparateTabButton(ComponentMediator, 121);
        }
