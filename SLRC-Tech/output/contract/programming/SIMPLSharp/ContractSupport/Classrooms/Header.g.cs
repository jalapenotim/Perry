...
namespace SLRCTech.Classrooms
{
    ...
    public partial interface IHeader 
    {
        ...
        /// <summary>
        /// Event Classrooms.Header.Lock Button.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> LockButton_PressEvent;

        /// <summary>
        /// Event Classrooms.Header.Main Page Button.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> MainPageButton_PressEvent;

        /// <summary>
        /// Classrooms.Header.Main Page Button.Visibility Feedback
        /// </summary>
        ...
        /// <summary>
        /// Classrooms.Header.Page Name Text.Indirect Rich Text Feedback
        /// </summary>
    ...
    internal partial class Header : IHeader, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Classrooms.Header.LockButton.Press
                /// Classrooms.Header.Lock Button.Press
                /// </summary>
                public const uint LockButton_PressEvent = 2;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Classrooms.Header.MainPageButton.Press
                /// Classrooms.Header.Main Page Button.Press
                /// </summary>
                public const uint MainPageButton_PressEvent = 3;


                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Classrooms.Header.MainPageButton.Visibility_fb
                /// Classrooms.Header.Main Page Button.Visibility
                /// </summary>
            ...
            internal static class Strings
            {
                ...
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: Classrooms.Header.PageNameText.IndirectRichText
                /// Classrooms.Header.Page Name Text.Indirect Rich Text
                /// </summary>
