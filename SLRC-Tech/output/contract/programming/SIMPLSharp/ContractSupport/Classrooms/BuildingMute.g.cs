...
namespace SLRCTech.Classrooms
{
    ...
    public partial interface IBuildingMute 
    {
        ...
        /// <summary>
        /// Event Classrooms.BuildingMute.Mute Off Button.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> MuteOffButton_PressEvent;

        /// <summary>
        /// Event Classrooms.BuildingMute.Mute On Button.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> MuteOnButton_PressEvent;

        /// <summary>
        /// Classrooms.BuildingMute.Building Mute Status.Visibility Feedback
        /// </summary>
        ...
        /// <summary>
        /// Classrooms.BuildingMute.Mute Off Button.Enable Feedback
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        ...
        /// <summary>
        /// Classrooms.BuildingMute.Mute On Button.Enable Feedback
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        ...
        /// <summary>
        /// Classrooms.BuildingMute.Mute Off Button.Selected Feedback
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        ...
        /// <summary>
        /// Classrooms.BuildingMute.Mute On Button.Selected Feedback
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        ...
        /// <summary>
        /// Classrooms.BuildingMute.Building Mute Status.Indirect Rich Text Feedback
        /// </summary>
        ...
        /// <summary>
        /// Classrooms.BuildingMute.Building Mute Text.Indirect Rich Text Feedback
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
    ...
    internal partial class BuildingMute : IBuildingMute, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Classrooms.BuildingMute.MuteOffButton.Press
                /// Classrooms.BuildingMute.Mute Off Button.Press
                /// </summary>
                public const uint MuteOffButton_PressEvent = 1;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Classrooms.BuildingMute.MuteOnButton.Press
                /// Classrooms.BuildingMute.Mute On Button.Press
                /// </summary>
                public const uint MuteOnButton_PressEvent = 2;


                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Classrooms.BuildingMute.BuildingMuteStatus.Visibility_fb
                /// Classrooms.BuildingMute.Building Mute Status.Visibility
                /// </summary>
                public const uint BuildingMuteStatus_Visibility_fbState = 1;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Classrooms.BuildingMute.MuteOffButton.Enable
                /// Classrooms.BuildingMute.Mute Off Button.Enable
                /// </summary>
                public const uint MuteOffButton_EnableState = 2;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Classrooms.BuildingMute.MuteOnButton.Enable
                /// Classrooms.BuildingMute.Mute On Button.Enable
                /// </summary>
                public const uint MuteOnButton_EnableState = 3;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Classrooms.BuildingMute.MuteOffButton.Selected
                /// Classrooms.BuildingMute.Mute Off Button.Selected
                /// </summary>
                public const uint MuteOffButton_SelectedState = 4;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Classrooms.BuildingMute.MuteOnButton.Selected
                /// Classrooms.BuildingMute.Mute On Button.Selected
                /// </summary>
            ...
            internal static class Strings
            {
                ...
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: Classrooms.BuildingMute.BuildingMuteStatus.IndirectRichText
                /// Classrooms.BuildingMute.Building Mute Status.Indirect Rich Text
                /// </summary>
                public const uint BuildingMuteStatus_IndirectRichTextState = 1;
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: Classrooms.BuildingMute.BuildingMuteText.IndirectRichText
                /// Classrooms.BuildingMute.Building Mute Text.Indirect Rich Text
                /// </summary>
