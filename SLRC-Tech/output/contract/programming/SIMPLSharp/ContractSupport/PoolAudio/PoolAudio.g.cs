...
namespace SLRCTech.PoolAudio
{
    ...
    public partial interface IPoolAudio
    {
        ...
        void VisibilityJoin(PoolAudioBoolInputSigDelegate callback);
        ...
        /// </summary>
        SLRCTech.PoolAudio.IHeader Header { get; }

        /// <summary>
        /// ComplexComponent Office Widget List
        /// </summary>
        SLRCTech.PoolAudio.OfficeWidgetList.IOfficeWidgetList OfficeWidgetList { get; }

        /// <summary>
        /// ComplexComponent Booth Widget List
        /// </summary>
        SLRCTech.PoolAudio.BoothWidgetList.IBoothWidgetList BoothWidgetList { get; }

        /// <summary>
        /// ComplexComponent Building Program Widget
        /// </summary>
        SLRCTech.PoolAudio.IBuildingProgramWidget BuildingProgramWidget { get; }

        /// <summary>
        /// ComplexComponent Building Mute
        /// </summary>
        SLRCTech.PoolAudio.IBuildingMute BuildingMute { get; }
    }
    ...
    internal partial class PoolAudio : IPoolAudio, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            internal static class Booleans
            {
                ...
                /// </summary>
                public const uint BleachersOffButton_SelectedState = 3;
                ...
                /// </summary>
                public const uint BleachersOnButton_SelectedState = 4;
                ...
                /// </summary>
                public const uint PerimeterOffButton_SelectedState = 5;
                ...
                /// </summary>
                public const uint PerimeterOnButton_SelectedState = 6;
        ...
        private void Initialize(uint controlJoinId, uint? itemCount)
        {
            ...
            Header = new SLRCTech.PoolAudio.Header(ComponentMediator, 40);
            OfficeWidgetList = new SLRCTech.PoolAudio.OfficeWidgetList.OfficeWidgetList(ComponentMediator, 41);
            BoothWidgetList = new SLRCTech.PoolAudio.BoothWidgetList.BoothWidgetList(ComponentMediator, 44);
            BuildingProgramWidget = new SLRCTech.PoolAudio.BuildingProgramWidget(ComponentMediator, 47);
            BuildingMute = new SLRCTech.PoolAudio.BuildingMute(ComponentMediator, 48);
        }
        ...
        public void AddDevice(BasicTriListWithSmartObject device)
        {
            ...
            ((SLRCTech.PoolAudio.Header)Header).AddDevice(device);

            ((SLRCTech.PoolAudio.OfficeWidgetList.OfficeWidgetList)OfficeWidgetList).AddDevice(device);

            ((SLRCTech.PoolAudio.BoothWidgetList.BoothWidgetList)BoothWidgetList).AddDevice(device);

            ((SLRCTech.PoolAudio.BuildingProgramWidget)BuildingProgramWidget).AddDevice(device);

            ((SLRCTech.PoolAudio.BuildingMute)BuildingMute).AddDevice(device);
        }
        ...
        ((SLRCTech.PoolAudio.Header)Header).RemoveDevice(device);

        ((SLRCTech.PoolAudio.OfficeWidgetList.OfficeWidgetList)OfficeWidgetList).RemoveDevice(device);

        ((SLRCTech.PoolAudio.BoothWidgetList.BoothWidgetList)BoothWidgetList).RemoveDevice(device);

        ((SLRCTech.PoolAudio.BuildingProgramWidget)BuildingProgramWidget).RemoveDevice(device);

        ((SLRCTech.PoolAudio.BuildingMute)BuildingMute).RemoveDevice(device);
        }
        ...
        /// <inheritdoc/>
        public void VisibilityJoin(PoolAudioBoolInputSigDelegate callback)
        {
        ...
        /// ComplexComponent Header
        /// </summary>
        public SLRCTech.PoolAudio.IHeader Header { get; private set; }

        /// <summary>
        /// ComplexComponent Office Widget List
        /// </summary>
        public SLRCTech.PoolAudio.OfficeWidgetList.IOfficeWidgetList OfficeWidgetList { get; private set; }

        /// <summary>
        /// ComplexComponent Booth Widget List
        /// </summary>
        public SLRCTech.PoolAudio.BoothWidgetList.IBoothWidgetList BoothWidgetList { get; private set; }

        /// <summary>
        /// ComplexComponent Building Program Widget
        /// </summary>
        public SLRCTech.PoolAudio.IBuildingProgramWidget BuildingProgramWidget { get; private set; }

        /// <summary>
        /// ComplexComponent Building Mute
        /// </summary>
        public SLRCTech.PoolAudio.IBuildingMute BuildingMute { get; private set; }
