...
namespace SLRCTech.Settings
{
    ...
    /// </summary>
    public partial interface IOFFTime2ButtonListByItem
    {
        /// <summary>
        ...
        void Button_Text(ushort buttonIndex, OFFTime2ButtonListStringInputSigDelegate callback);
    ...
    /// Search List
    /// </summary>
    internal partial class OFFTime2ButtonList
    {
        #region CH5 Contract
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        public void Button_Text(ushort buttonIndex, OFFTime2ButtonListStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
    ...
    /// <summary>
    /// OFF Time 2 Button List
    /// </summary>
    public partial interface IOFFTime2ButtonList : IOFFTime2ButtonListByItem
    {
        ...
        void OFFTime2ButtonList_ListNumberOfItems(short analog);

        /// <summary>
        /// OFF Time 2 Button List.List Number Of Items Feedback
        /// </summary>
        /// <param name="callback">The ushort analog to update the panel.</param>
        void OFFTime2ButtonList_ListNumberOfItems(ushort analog);

        /// <summary>
        /// OFF Time 2 Button List.List Number Of Items Feedback
        /// </summary>
        /// <param name="callback">The ushort delegate to update the panel.</param>
        void OFFTime2ButtonList_ListNumberOfItems(OFFTime2ButtonListUShortInputSigDelegate callback);
        ...
        void Button_1_Button_Text(OFFTime2ButtonListStringInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
        void Button_2_Button_Text(OFFTime2ButtonListStringInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
        void Button_3_Button_Text(OFFTime2ButtonListStringInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
        void Button_4_Button_Text(OFFTime2ButtonListStringInputSigDelegate callback);
    }
    ...
    /// <param name="offtime2buttonlist">The <see cref="IOFFTime2ButtonList"/> on which to apply the feedback.</param>
    public delegate void OFFTime2ButtonListBoolInputSigDelegate(BoolInputSig boolInputSig, IOFFTime2ButtonList offtime2buttonlist);
    /// <summary>
    /// Digital callback used in feedback events.
    /// </summary>
    /// <param name="uShortInputSig">The <see cref="UShortInputSig"/> joinInfo data.</param>
    /// <param name="offtime2buttonlist">The <see cref="IOFFTime2ButtonList"/> on which to apply the feedback.</param>
    public delegate void OFFTime2ButtonListUShortInputSigDelegate(UShortInputSig uShortInputSig, IOFFTime2ButtonList offtime2buttonlist);
    /// <summary>
    /// Digital callback used in feedback events.
    /// </summary>
    /// <param name="stringInputSig">The <see cref="StringInputSig"/> joinInfo data.</param>
    /// <param name="offtime2buttonlist">The <see cref="IOFFTime2ButtonList"/> on which to apply the feedback.</param>
    public delegate void OFFTime2ButtonListStringInputSigDelegate(StringInputSig stringInputSig, IOFFTime2ButtonList offtime2buttonlist);

    /// <summary>
    /// OFF Time 2 Button List
    /// </summary>
    internal partial class OFFTime2ButtonList : IOFFTime2ButtonList, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Settings.OFFTime2ButtonList.Button1ItemPress
                /// Button1.ItemPress
                /// </summary>
                public const uint Button_1_Button_PressEvent = 1001;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Settings.OFFTime2ButtonList.Button2ItemPress
                /// Button2.ItemPress
                /// </summary>
                public const uint Button_2_Button_PressEvent = 1002;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Settings.OFFTime2ButtonList.Button3ItemPress
                /// Button3.ItemPress
                /// </summary>
                public const uint Button_3_Button_PressEvent = 1003;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Settings.OFFTime2ButtonList.Button4ItemPress
                /// Button4.ItemPress
                /// </summary>
            ...
            {
                /// <summary>
                /// Input or Feedback analog joinInfo from Control System to panel: Settings.OFFTime2ButtonList.ListNumberOfItems
                /// OFF Time 2 Button List.List Number Of Items
                /// </summary>
                public const uint OFFTime2ButtonList_ListNumberOfItemsState = 2;
            ...
            internal static class Strings
            {
                ...
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: Settings.OFFTime2ButtonList.Button1Text
                /// Button1.Text
                /// </summary>
                public const uint Button_1_Button_TextState = 1;
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: Settings.OFFTime2ButtonList.Button2Text
                /// Button2.Text
                /// </summary>
                public const uint Button_2_Button_TextState = 2;
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: Settings.OFFTime2ButtonList.Button3Text
                /// Button3.Text
                /// </summary>
                public const uint Button_3_Button_TextState = 3;
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: Settings.OFFTime2ButtonList.Button4Text
                /// Button4.Text
                /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OFFTime2ButtonList"/> component class.
        /// </summary>
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        /// <param name="itemCount">The number of items.</param>
        internal OFFTime2ButtonList(ComponentMediator componentMediator, uint controlJoinId, uint? itemCount)
        {
        ...
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        internal OFFTime2ButtonList(ComponentMediator componentMediator, uint controlJoinId) : this(componentMediator, controlJoinId, null)
        {
        }
        ...
        /// <inheritdoc/>
        public void OFFTime2ButtonList_ListNumberOfItems(short analog)
        {
            OFFTime2ButtonList_ListNumberOfItems((sig, component) => sig.ShortValue = analog);
        }

        /// <inheritdoc/>
        public void OFFTime2ButtonList_ListNumberOfItems(ushort analog)
        {
            OFFTime2ButtonList_ListNumberOfItems((sig, component) => sig.UShortValue = analog);
        }
        ...
        public void OFFTime2ButtonList_ListNumberOfItems(OFFTime2ButtonListUShortInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
                callback(Devices[index].SmartObjects[ControlJoinId].UShortInput[Joins.Numerics.OFFTime2ButtonList_ListNumberOfItemsState], this);
            }
        }
        ...
        /// <inheritdoc/>
        public void Button_1_Button_Text(OFFTime2ButtonListStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_2_Button_Text(OFFTime2ButtonListStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_3_Button_Text(OFFTime2ButtonListStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_4_Button_Text(OFFTime2ButtonListStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        {
            return string.Format("Contract: {0} Component: {1} HashCode: {2} {3}", "OFFTime2ButtonList", GetType().Name, GetHashCode(), UserObject != null ? "UserObject: " + UserObject : null);
        }
