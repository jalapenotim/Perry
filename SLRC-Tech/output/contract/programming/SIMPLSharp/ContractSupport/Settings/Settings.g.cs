...
namespace SLRCTech.Settings
{
    ...
    public partial interface ISettings
    {
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void VisibilityJoin(SettingsBoolInputSigDelegate callback);
    ...
    internal partial class Settings : ISettings, IDisposable
    {
        ...
        private void Initialize(uint controlJoinId, uint? itemCount)
        {
            ...
            Header = new SLRCTech.Settings.Header(ComponentMediator, 124);
            PasswordSetKeypad = new SLRCTech.Settings.PasswordSetKeypad(ComponentMediator, 125);
            ...
            OFFTime1ButtonList = new SLRCTech.Settings.OFFTime1ButtonList(ComponentMediator, 128);
            ONTime2ButtonList = new SLRCTech.Settings.ONTime2ButtonList(ComponentMediator, 129);
            OFFTime2ButtonList = new SLRCTech.Settings.OFFTime2ButtonList(ComponentMediator, 130);
            BuildingMute = new SLRCTech.Settings.BuildingMute(ComponentMediator, 131);
        }
        ...
        /// <inheritdoc/>
        public void VisibilityJoin(SettingsBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
