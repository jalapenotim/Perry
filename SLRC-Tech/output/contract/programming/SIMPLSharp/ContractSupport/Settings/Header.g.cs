...
namespace SLRCTech.Settings
{
    ...
    public partial interface IHeader 
    {
        ...
        /// <summary>
        /// Event Settings.Header.Lock Button.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> LockButton_PressEvent;

        /// <summary>
        /// Event Settings.Header.Main Page Button.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> MainPageButton_PressEvent;

        /// <summary>
        /// Settings.Header.Main Page Button.Visibility Feedback
        /// </summary>
        ...
        /// <summary>
        /// Settings.Header.Page Name Text.Indirect Rich Text Feedback
        /// </summary>
    ...
    internal partial class Header : IHeader, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Settings.Header.LockButton.Press
                /// Settings.Header.Lock Button.Press
                /// </summary>
                public const uint LockButton_PressEvent = 2;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Settings.Header.MainPageButton.Press
                /// Settings.Header.Main Page Button.Press
                /// </summary>
                public const uint MainPageButton_PressEvent = 3;


                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Settings.Header.MainPageButton.Visibility_fb
                /// Settings.Header.Main Page Button.Visibility
                /// </summary>
            ...
            internal static class Strings
            {
                ...
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: Settings.Header.PageNameText.IndirectRichText
                /// Settings.Header.Page Name Text.Indirect Rich Text
                /// </summary>
