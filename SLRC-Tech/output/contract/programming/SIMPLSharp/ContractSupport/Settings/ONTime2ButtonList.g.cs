...
namespace SLRCTech.Settings
{
    ...
    /// </summary>
    public partial interface IONTime2ButtonListByItem
    {
        /// <summary>
        ...
        void Button_Selected(ushort buttonIndex, ONTime2ButtonListBoolInputSigDelegate callback);
        ...
        void Button_Text(ushort buttonIndex, ONTime2ButtonListStringInputSigDelegate callback);
    ...
    /// Search List
    /// </summary>
    internal partial class ONTime2ButtonList
    {
        #region CH5 Contract
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        public void Button_Selected(ushort buttonIndex, ONTime2ButtonListBoolInputSigDelegate callback)
        {
        ...
        /// <inheritdoc/>
        public void Button_Text(ushort buttonIndex, ONTime2ButtonListStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
    ...
    /// <summary>
    /// ON Time 2 Button List
    /// </summary>
    public partial interface IONTime2ButtonList : IONTime2ButtonListByItem
    {
        ...
        void Button_1_Button_Selected(ONTime2ButtonListBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Button_2_Button_Selected(ONTime2ButtonListBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Button_3_Button_Selected(ONTime2ButtonListBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Button_4_Button_Selected(ONTime2ButtonListBoolInputSigDelegate callback);

        /// <summary>
        /// ON Time 2 Button List.List Number Of Items Feedback
        /// </summary>
        /// <param name="callback">The short analog to update the panel.</param>
        void ONTime2ButtonList_ListNumberOfItems(short analog);

        /// <summary>
        /// ON Time 2 Button List.List Number Of Items Feedback
        /// </summary>
        /// <param name="callback">The ushort analog to update the panel.</param>
        void ONTime2ButtonList_ListNumberOfItems(ushort analog);

        /// <summary>
        /// ON Time 2 Button List.List Number Of Items Feedback
        /// </summary>
        /// <param name="callback">The ushort delegate to update the panel.</param>
        void ONTime2ButtonList_ListNumberOfItems(ONTime2ButtonListUShortInputSigDelegate callback);
        ...
        void Button_1_Button_Text(ONTime2ButtonListStringInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
        void Button_2_Button_Text(ONTime2ButtonListStringInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
        void Button_3_Button_Text(ONTime2ButtonListStringInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
        void Button_4_Button_Text(ONTime2ButtonListStringInputSigDelegate callback);
    }
    ...
    /// <param name="ontime2buttonlist">The <see cref="IONTime2ButtonList"/> on which to apply the feedback.</param>
    public delegate void ONTime2ButtonListBoolInputSigDelegate(BoolInputSig boolInputSig, IONTime2ButtonList ontime2buttonlist);
    /// <summary>
    /// Digital callback used in feedback events.
    /// </summary>
    /// <param name="uShortInputSig">The <see cref="UShortInputSig"/> joinInfo data.</param>
    /// <param name="ontime2buttonlist">The <see cref="IONTime2ButtonList"/> on which to apply the feedback.</param>
    public delegate void ONTime2ButtonListUShortInputSigDelegate(UShortInputSig uShortInputSig, IONTime2ButtonList ontime2buttonlist);
    /// <summary>
    /// Digital callback used in feedback events.
    /// </summary>
    /// <param name="stringInputSig">The <see cref="StringInputSig"/> joinInfo data.</param>
    /// <param name="ontime2buttonlist">The <see cref="IONTime2ButtonList"/> on which to apply the feedback.</param>
    public delegate void ONTime2ButtonListStringInputSigDelegate(StringInputSig stringInputSig, IONTime2ButtonList ontime2buttonlist);

    /// <summary>
    /// ON Time 2 Button List
    /// </summary>
    internal partial class ONTime2ButtonList : IONTime2ButtonList, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Settings.ONTime2ButtonList.Button1ItemPress
                /// Button1.ItemPress
                /// </summary>
                public const uint Button_1_Button_PressEvent = 1001;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Settings.ONTime2ButtonList.Button2ItemPress
                /// Button2.ItemPress
                /// </summary>
                public const uint Button_2_Button_PressEvent = 1002;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Settings.ONTime2ButtonList.Button3ItemPress
                /// Button3.ItemPress
                /// </summary>
                public const uint Button_3_Button_PressEvent = 1003;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Settings.ONTime2ButtonList.Button4ItemPress
                /// Button4.ItemPress
                /// </summary>
                ...
                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Settings.ONTime2ButtonList.Button1ItemSelected
                /// Button1.ItemSelected
                /// </summary>
                public const uint Button_1_Button_SelectedState = 1001;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Settings.ONTime2ButtonList.Button2ItemSelected
                /// Button2.ItemSelected
                /// </summary>
                public const uint Button_2_Button_SelectedState = 1002;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Settings.ONTime2ButtonList.Button3ItemSelected
                /// Button3.ItemSelected
                /// </summary>
                public const uint Button_3_Button_SelectedState = 1003;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Settings.ONTime2ButtonList.Button4ItemSelected
            ...
            {
                /// <summary>
                /// Input or Feedback analog joinInfo from Control System to panel: Settings.ONTime2ButtonList.ListNumberOfItems
                /// ON Time 2 Button List.List Number Of Items
                /// </summary>
                public const uint ONTime2ButtonList_ListNumberOfItemsState = 2;
            ...
            internal static class Strings
            {
                ...
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: Settings.ONTime2ButtonList.Button1Text
                /// Button1.Text
                /// </summary>
                public const uint Button_1_Button_TextState = 1;
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: Settings.ONTime2ButtonList.Button2Text
                /// Button2.Text
                /// </summary>
                public const uint Button_2_Button_TextState = 2;
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: Settings.ONTime2ButtonList.Button3Text
                /// Button3.Text
                /// </summary>
                public const uint Button_3_Button_TextState = 3;
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: Settings.ONTime2ButtonList.Button4Text
                /// Button4.Text
                /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ONTime2ButtonList"/> component class.
        /// </summary>
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        /// <param name="itemCount">The number of items.</param>
        internal ONTime2ButtonList(ComponentMediator componentMediator, uint controlJoinId, uint? itemCount)
        {
        ...
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        internal ONTime2ButtonList(ComponentMediator componentMediator, uint controlJoinId) : this(componentMediator, controlJoinId, null)
        {
        }
        ...
        /// <inheritdoc/>
        public void Button_1_Button_Selected(ONTime2ButtonListBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_2_Button_Selected(ONTime2ButtonListBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_3_Button_Selected(ONTime2ButtonListBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_4_Button_Selected(ONTime2ButtonListBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void ONTime2ButtonList_ListNumberOfItems(short analog)
        {
            ONTime2ButtonList_ListNumberOfItems((sig, component) => sig.ShortValue = analog);
        }

        /// <inheritdoc/>
        public void ONTime2ButtonList_ListNumberOfItems(ushort analog)
        {
            ONTime2ButtonList_ListNumberOfItems((sig, component) => sig.UShortValue = analog);
        }

        /// <inheritdoc/>
        public void ONTime2ButtonList_ListNumberOfItems(ONTime2ButtonListUShortInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
                callback(Devices[index].SmartObjects[ControlJoinId].UShortInput[Joins.Numerics.ONTime2ButtonList_ListNumberOfItemsState], this);
            }
        }
        ...
        /// <inheritdoc/>
        public void Button_1_Button_Text(ONTime2ButtonListStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_2_Button_Text(ONTime2ButtonListStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_3_Button_Text(ONTime2ButtonListStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_4_Button_Text(ONTime2ButtonListStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        {
            return string.Format("Contract: {0} Component: {1} HashCode: {2} {3}", "ONTime2ButtonList", GetType().Name, GetHashCode(), UserObject != null ? "UserObject: " + UserObject : null);
        }
