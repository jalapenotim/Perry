...
namespace SLRCTech.Settings
{
    ...
    /// </summary>
    public partial interface IOFFTime1ButtonListByItem
    {
        /// <summary>
        ...
        void Button_Selected(ushort buttonIndex, OFFTime1ButtonListBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="buttonIndex">The index of the button (0 based).</param>
        /// <param name="callback">The serial delegate to set the feedback.</param>
        void Button_Text(ushort buttonIndex, OFFTime1ButtonListStringInputSigDelegate callback);
    ...
    /// Search List
    /// </summary>
    internal partial class OFFTime1ButtonList
    {
        #region CH5 Contract
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        public void Button_Selected(ushort buttonIndex, OFFTime1ButtonListBoolInputSigDelegate callback)
        {
        ...
        /// <inheritdoc/>
        public void Button_Text(ushort buttonIndex, OFFTime1ButtonListStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
    ...
    /// <summary>
    /// OFF Time 1 Button List
    /// </summary>
    public partial interface IOFFTime1ButtonList : IOFFTime1ButtonListByItem
    {
        ...
        void Button_1_Button_Selected(OFFTime1ButtonListBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Button_2_Button_Selected(OFFTime1ButtonListBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Button_3_Button_Selected(OFFTime1ButtonListBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Button_4_Button_Selected(OFFTime1ButtonListBoolInputSigDelegate callback);

        /// <summary>
        /// OFF Time 1 Button List.List Number Of Items Feedback
        /// </summary>
        /// <param name="callback">The short analog to update the panel.</param>
        void OFFTime1ButtonList_ListNumberOfItems(short analog);

        /// <summary>
        /// OFF Time 1 Button List.List Number Of Items Feedback
        /// </summary>
        /// <param name="callback">The ushort analog to update the panel.</param>
        void OFFTime1ButtonList_ListNumberOfItems(ushort analog);

        /// <summary>
        /// OFF Time 1 Button List.List Number Of Items Feedback
        /// </summary>
        /// <param name="callback">The ushort delegate to update the panel.</param>
        void OFFTime1ButtonList_ListNumberOfItems(OFFTime1ButtonListUShortInputSigDelegate callback);
        ...
        void Button_1_Button_Text(OFFTime1ButtonListStringInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
        void Button_2_Button_Text(OFFTime1ButtonListStringInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
        void Button_3_Button_Text(OFFTime1ButtonListStringInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
        void Button_4_Button_Text(OFFTime1ButtonListStringInputSigDelegate callback);
    }
    ...
    /// <param name="offtime1buttonlist">The <see cref="IOFFTime1ButtonList"/> on which to apply the feedback.</param>
    public delegate void OFFTime1ButtonListBoolInputSigDelegate(BoolInputSig boolInputSig, IOFFTime1ButtonList offtime1buttonlist);
    /// <summary>
    /// Digital callback used in feedback events.
    /// </summary>
    /// <param name="uShortInputSig">The <see cref="UShortInputSig"/> joinInfo data.</param>
    /// <param name="offtime1buttonlist">The <see cref="IOFFTime1ButtonList"/> on which to apply the feedback.</param>
    public delegate void OFFTime1ButtonListUShortInputSigDelegate(UShortInputSig uShortInputSig, IOFFTime1ButtonList offtime1buttonlist);
    /// <summary>
    /// Digital callback used in feedback events.
    /// </summary>
    /// <param name="stringInputSig">The <see cref="StringInputSig"/> joinInfo data.</param>
    /// <param name="offtime1buttonlist">The <see cref="IOFFTime1ButtonList"/> on which to apply the feedback.</param>
    public delegate void OFFTime1ButtonListStringInputSigDelegate(StringInputSig stringInputSig, IOFFTime1ButtonList offtime1buttonlist);

    /// <summary>
    /// OFF Time 1 Button List
    /// </summary>
    internal partial class OFFTime1ButtonList : IOFFTime1ButtonList, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Settings.OFFTime1ButtonList.Button1ItemPress
                /// Button1.ItemPress
                /// </summary>
                public const uint Button_1_Button_PressEvent = 1001;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Settings.OFFTime1ButtonList.Button2ItemPress
                /// Button2.ItemPress
                /// </summary>
                public const uint Button_2_Button_PressEvent = 1002;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Settings.OFFTime1ButtonList.Button3ItemPress
                /// Button3.ItemPress
                /// </summary>
                public const uint Button_3_Button_PressEvent = 1003;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Settings.OFFTime1ButtonList.Button4ItemPress
                /// Button4.ItemPress
                /// </summary>
                ...
                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Settings.OFFTime1ButtonList.Button1ItemSelected
                /// Button1.ItemSelected
                /// </summary>
                public const uint Button_1_Button_SelectedState = 1001;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Settings.OFFTime1ButtonList.Button2ItemSelected
                /// Button2.ItemSelected
                /// </summary>
                public const uint Button_2_Button_SelectedState = 1002;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Settings.OFFTime1ButtonList.Button3ItemSelected
                /// Button3.ItemSelected
                /// </summary>
                public const uint Button_3_Button_SelectedState = 1003;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Settings.OFFTime1ButtonList.Button4ItemSelected
            ...
            {
                /// <summary>
                /// Input or Feedback analog joinInfo from Control System to panel: Settings.OFFTime1ButtonList.ListNumberOfItems
                /// OFF Time 1 Button List.List Number Of Items
                /// </summary>
                public const uint OFFTime1ButtonList_ListNumberOfItemsState = 2;
            ...
            internal static class Strings
            {
                ...
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: Settings.OFFTime1ButtonList.Button1Text
                /// Button1.Text
                /// </summary>
                public const uint Button_1_Button_TextState = 1;
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: Settings.OFFTime1ButtonList.Button2Text
                /// Button2.Text
                /// </summary>
                public const uint Button_2_Button_TextState = 2;
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: Settings.OFFTime1ButtonList.Button3Text
                /// Button3.Text
                /// </summary>
                public const uint Button_3_Button_TextState = 3;
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: Settings.OFFTime1ButtonList.Button4Text
                /// Button4.Text
                /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OFFTime1ButtonList"/> component class.
        /// </summary>
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        /// <param name="itemCount">The number of items.</param>
        internal OFFTime1ButtonList(ComponentMediator componentMediator, uint controlJoinId, uint? itemCount)
        {
        ...
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        internal OFFTime1ButtonList(ComponentMediator componentMediator, uint controlJoinId) : this(componentMediator, controlJoinId, null)
        {
        }
        ...
        private Indexes GetIndexes(uint controlJoinId, uint join, eSigType eSigType)
        {
            if (controlJoinId == ControlJoinId &&
                ...
                join <= Joins.Booleans.Button_4_Button_PressEvent)
            {
        ...
        /// <inheritdoc/>
        public void Button_1_Button_Selected(OFFTime1ButtonListBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_2_Button_Selected(OFFTime1ButtonListBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_3_Button_Selected(OFFTime1ButtonListBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_4_Button_Selected(OFFTime1ButtonListBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void OFFTime1ButtonList_ListNumberOfItems(short analog)
        {
            OFFTime1ButtonList_ListNumberOfItems((sig, component) => sig.ShortValue = analog);
        }

        /// <inheritdoc/>
        public void OFFTime1ButtonList_ListNumberOfItems(ushort analog)
        {
            OFFTime1ButtonList_ListNumberOfItems((sig, component) => sig.UShortValue = analog);
        }

        /// <inheritdoc/>
        public void OFFTime1ButtonList_ListNumberOfItems(OFFTime1ButtonListUShortInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
                callback(Devices[index].SmartObjects[ControlJoinId].UShortInput[Joins.Numerics.OFFTime1ButtonList_ListNumberOfItemsState], this);
            }
        }
        ...
        /// <inheritdoc/>
        public void Button_1_Button_Text(OFFTime1ButtonListStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_2_Button_Text(OFFTime1ButtonListStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_3_Button_Text(OFFTime1ButtonListStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_4_Button_Text(OFFTime1ButtonListStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        {
            return string.Format("Contract: {0} Component: {1} HashCode: {2} {3}", "OFFTime1ButtonList", GetType().Name, GetHashCode(), UserObject != null ? "UserObject: " + UserObject : null);
        }
