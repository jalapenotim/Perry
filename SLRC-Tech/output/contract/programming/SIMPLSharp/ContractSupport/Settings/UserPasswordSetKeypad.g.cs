...
namespace SLRCTech.Settings
{
    ...
    /// </summary>
    public partial interface IUserPasswordSetKeypadByItem
    {
        /// <summary>
    ...
    /// Search List
    /// </summary>
    internal partial class UserPasswordSetKeypad
    {
        #region CH5 Contract
        /// <inheritdoc/>
    ...
    /// <summary>
    /// User Password Set Keypad
    /// </summary>
    public partial interface IUserPasswordSetKeypad : IUserPasswordSetKeypadByItem
    {
    ...
    /// <param name="userpasswordsetkeypad">The <see cref="IUserPasswordSetKeypad"/> on which to apply the feedback.</param>
    public delegate void UserPasswordSetKeypadBoolInputSigDelegate(BoolInputSig boolInputSig, IUserPasswordSetKeypad userpasswordsetkeypad);

    /// <summary>
    /// User Password Set Keypad
    /// </summary>
    internal partial class UserPasswordSetKeypad : IUserPasswordSetKeypad, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Settings.UserPasswordSetKeypad.Press1
                /// Press1.Press
                /// </summary>
                public const uint Press1Event = 3;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Settings.UserPasswordSetKeypad.Press2
                /// Press2.Press
                /// </summary>
                public const uint Press2Event = 4;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Settings.UserPasswordSetKeypad.Press3
                /// Press3.Press
                /// </summary>
                public const uint Press3Event = 5;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Settings.UserPasswordSetKeypad.Press4
                /// Press4.Press
                /// </summary>
                public const uint Press4Event = 6;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Settings.UserPasswordSetKeypad.Press5
                /// Press5.Press
                /// </summary>
                public const uint Press5Event = 7;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Settings.UserPasswordSetKeypad.Press6
                /// Press6.Press
                /// </summary>
                public const uint Press6Event = 8;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Settings.UserPasswordSetKeypad.Press7
                /// Press7.Press
                /// </summary>
                public const uint Press7Event = 9;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Settings.UserPasswordSetKeypad.Press8
                /// Press8.Press
                /// </summary>
                public const uint Press8Event = 10;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Settings.UserPasswordSetKeypad.Press9
                /// Press9.Press
                /// </summary>
                public const uint Press9Event = 11;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Settings.UserPasswordSetKeypad.Press0
                /// Press0.Press
                /// </summary>
                public const uint Press0Event = 12;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Settings.UserPasswordSetKeypad.PressStar
                /// PressStar.Press
                /// </summary>
                public const uint PressStarEvent = 13;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Settings.UserPasswordSetKeypad.PressHash
                /// PressHash.Press
                /// </summary>
                public const uint PressHashEvent = 14;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Settings.UserPasswordSetKeypad.PressExtraButton
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserPasswordSetKeypad"/> component class.
        /// </summary>
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        /// <param name="itemCount">The number of items.</param>
        internal UserPasswordSetKeypad(ComponentMediator componentMediator, uint controlJoinId, uint? itemCount)
        {
        ...
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        internal UserPasswordSetKeypad(ComponentMediator componentMediator, uint controlJoinId) : this(componentMediator, controlJoinId, null)
        {
        }
        ...
        {
            return string.Format("Contract: {0} Component: {1} HashCode: {2} {3}", "UserPasswordSetKeypad", GetType().Name, GetHashCode(), UserObject != null ? "UserObject: " + UserObject : null);
        }
